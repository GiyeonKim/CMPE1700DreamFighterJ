...
namespace CMPE1700GiyeonKimICAs05
{
      class DeckofCards 
    {
       ...
       public Cards Random() // calls the card to generate random and shuffle them
        {
            Shuffle();
            Random Randn = new Random();
            int i = 0;
       ...
       public Players DetermineWinner(Players One, Players Two) // determine the winner of the players
       {
           return null;
       }
